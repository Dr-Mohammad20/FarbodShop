  ...
  return (
    <>
      ...
      <div className="w-[100dvw] min-h-[100dvh] h-fit flex flex-col justify-center items-center px-2 bg-black">
        ...
        <div className="h-[13dvh] w-full flex flex-row-reverse justify-center items-center gap-4 text-xl xl:text-3xl bg-black/[0.7] BorderDownPioneer">
          <Link
            href="/Products"
            className="h-full w-1/4 flex justify-center items-center text-Pioneer font-IranianSans">
            محصولات
          </Link>
          <Link
            href="/"
            className="h-full w-1/2 flex justify-center items-center text-Pioneer font-IranianSans text-[60px]">
            فروشگاه فربد
          </Link>
          <Link
            href="/AboutUs"
