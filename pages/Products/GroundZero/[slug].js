...
import HeaderImage from '../../../assets/images/Up-Page-AboutUs.jpg';
...
export const getServerSideProps = async (context) => {
  ...
  console.log('Context data is : ', context.res);
  ...
  return (
    <div className="w-ful flex-col">
      ...
      <div className="flex flex-col lg:flex-row md:px-10 gap-[10px] lg:gap-[100px] min-h-[75dvh] py-10 px-10 backGround">
        ...
        <div className="flex-[1] py-5 DirectionRTL BackMorphism px-10 TextColor">
          {/* Product Title */}
          <div className="flex justify-between items-center mb-2">
            <div className="text-[34px] font-semibold">
              {productData.type} {productData.brand}
            </div>
            <Link href="/Products/GroundZero">
